...
class TestPrototypeFunctions(unittest.TestCase):
    ...
    def test_to_index(self):
        ...
        self.assertEqual(2, index.get("root_-5995064038896156292"))
        self.assertEqual(4, index.get("test_703899357396914538"))
        self.assertEqual(4, index.get("muh_703899357396914538"))
        self.assertEqual(3, index.node_count())
        self.assertEqual({"duration": [2, 2]}, index["muh_703899357396914538"])

        index = prototype.to_index(signature=ParentChildByNameTopologySignature(), exit_support=False)
        self.assertEqual(3, index.node_count())
        self.assertEqual(1, index.get("root_-5995064038896156292"))
        self.assertEqual(2, index.get("test_703899357396914538"))
        self.assertEqual(2, index.get("muh_703899357396914538"))
