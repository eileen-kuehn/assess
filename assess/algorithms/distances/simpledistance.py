...
class SimpleDistance(Distance):
    ...
    * Recursive version: Too long ;)
    ...
    def _update_distances(self, prototype_nodes=None, node_signature=None, prototypes=None, signature_prototypes=None):
...
class SimpleDistance2(Distance):
    ...
    def update_distance(self, signature=None, matching_prototypes=None, prototypes=None, signature_prototypes=None):
        if signature not in self._measured_nodes:
            self._update_distances(
                    prototype_nodes=matching_prototypes,
                    node_signature=signature,
